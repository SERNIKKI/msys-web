        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-6">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-3">中评列表</h4>
                            <div class="inbox-wid">
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">这家店的面一般般</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">份量不太够，不能吃饱</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">里面肉有点多</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">味道一般般啊</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">汤里面配料有点少啊</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">汤有点淡</p>
                                        <p class="inbox-item-date text-muted">11:47 AM</p>
                                    </div>
                                </a>

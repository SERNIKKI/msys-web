...
<div class="wrapper">
    <div class="page-title-box">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">顾客投诉</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.jsp">主页</a>
                        <li class="breadcrumb-item"><a>顾客反馈</a>
                        <li class="breadcrumb-item active">顾客投诉
                    </ol>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="page-title">投诉数量：</h4>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-3">投诉列表</h4>
                            <div class="inbox-wid">
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">你们的肉可真珍贵</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">这份量太少了</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">希望带点肉</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">味道需要改善</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">汤里面配料多添一点</p>
                                ...
                                <a href="#" class="text-dark">
                                    <div class="inbox-item">
                                        ...
                                        <p class="inbox-item-text text-muted mb-0">汤里面配料太少了</p>
                                        <p class="inbox-item-date text-muted">11:47 AM</p>
                                    </div>
                                </a>

                ...
                <ul class="navbar-right d-flex list-inline float-right mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <div class="dropdown notification-list">
                            <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user waves-light" href="#" role="button" aria-haspopup="false" aria-expanded="false">
...
<script type="text/javascript">
    ...
    function a(){
        ...
        var url="${pageContext.request.contextPath}/canting/servlet/food/dishShow"
        $.ajax({
            url:url,
            type:"POST",
            ...
            success:function(data){
                var i;
                var html="";
                console.log(data);$("#food_show").empty();
                if(data!=null) {

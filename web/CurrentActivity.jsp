            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <h4 class="mt-0 header-title">活动展图</h4>
                            <div id="carouselExampleCaption" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner" id="activityshow" role="listbox">
                                <%--  展示  --%>
                                </div>
...
<script type="text/javascript">
                ...
                if(data.length<=4){
                    for(k=0;k<data.length;k++){
                        ihtml+='<a href="#" class="text-dark">\n' +
                            ...
                            '                                        <a href="#" class="btn btn-primary float-md-right" id='+data[k].aid+' onclick="cancel(this)">撤销</a>\n' +
                            '\n' +
                            '                                    </div>\n' +
                            '                                </a>';
                    }
   ...
   function cancel(o) {
       var answer=window.confirm("确定要撤销这个活动吗？");
       if(!answer){
           return;
       }
       var id=o.id;
       var url="${pageContext.request.contextPath}/canting/servlet/activity/cancel"
       $.ajax({
           url:url,
           method:"post",
           data:{"id":id},

...
@WebServlet(name="Activity_showServlet",urlPatterns = {"/canting/servlet/activity/show"})
public class Activity_showServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws  IOException {
        ...
        try {
            list = new Store_activityDao().selectactivity(S_id, 1);
